...
function DriversSection() {
  const data = [
    {
      id: 1,
      src: "/images/homePage/drivers/180x100-income.png",
    ...
    {
      id: 2,
      src: "/images/homePage/drivers/180x100-hour.png",
    ...
    {
      id: 3,
      src: "/images/homePage/drivers/180x100-benefits.png",
    ...
    {
      id: 4,
      src: "/images/homePage/drivers/180x100-carfix.png",
      title: "کار‌فیکس",
      description:
    ...
    {
      id: 5,
      src: "/images/homePage/drivers/safety.svg",
    ...
    {
      id: 6,
      src: "/images/homePage/drivers/support.svg",
  ...
  return (
    <div className="bg-gray-100 px-5 py-10">
      <div className="bg-red-20  w-full">
        ...
        >
          <source
            src="/images/homePage/drivers/jazbranandeh1.mp4"
            type="video/mp4"
          />
